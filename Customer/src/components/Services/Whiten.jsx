            ...
            <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, marginLeft: { md: "50px" }, marginTop: { md: "70px" }, gap: "20px", padding: { md: "20px" }, justifyContent: "center", alignItems: "center", minHeight: "100vh" }}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{ margin: "1rem" }}>
                        ...
                        <Typography>
                            Tẩy trắng răng là một kỹ thuật nha khoa giúp răng trắng sáng hơn so với màu răng ban đầu một cách an toàn.
                        </Typography>
                    </Box>
                    {/* Main Image */}
                    ...
                    <Box sx={{ marginTop: "20px" }}>
                        ...
                        {tabIndex === 1 && (
                            <Box sx={{ padding: "20px", backgroundColor: "#f9f9f9", borderRadius: "8px", marginTop: "10px" }}>
                                <Typography variant="h6" color="orange">Tẩy trắng răng là gì? Tẩy trắng răng có tốt không?</Typography>
                                <Box marginLeft={"10px"}>
                                    <Typography>
                                        Tẩy trắng răng là phương pháp giúp khôi phục và cải thiện tình trạng răng ố vàng được nhiều người ưa chuộng hiện nay.
                                        Là phương pháp thẫm mỹ nha khoa đơn giản với mức giá không quá cao, đây được xem là một trong những các đơn giản để có được một hàm răng trắng đều và đẹp.
                                        <br /> <br /> </Typography>
                                </Box>
                                ...
                                <Box>
                                    ...
                                    <Box marginLeft={"10px"}>
                                        ...
                                        <Typography >
                                            ...
                                            - Người mắc các bệnh lý nghiêm trọng về răng miệng như: viêm nha chu, hở chân răng, mòn cổ răng.<br />
                                            - Người có tiền sử dị ứng hoặc có dấu hiệu dị ứng với thuốc tẩy trắng răng.<br />
                                            - Trẻ em dưới 16 tuổi không nên tẩy răng vì lúc này răng còn yếu nên sẽ gây ảnh hưởng lớn lên tủy.<br />
                                            <br />
                                            <br></br>
                                        </Typography>
                                    </Box>
                ...
                >
                    ...
                    <FormControl fullWidth margin="normal">
                        ...
                        >
                            ...
                            <MenuItem value="Tẩy trắng răng tại phòng khám và tại nhà">Tẩy trắng rang tịa phòng khám và tại nhà</MenuItem>
