...
const PatientDetail = ({ open, onClose, patient }) => {
  ...
  useEffect(() => {
    if (patient) {
      ...
      setFormData({
        ...
        employeePhone: patient.employeePhone,
        employeeEmail: patient.employeeEmail,
        address: patient.address,
        employeeSpecialization: patient.employeeSpecialization || [],
        workingTime: workingTimeObject,
        urlAvatar: patient.urlAvatar,
        isWorking: patient.isWorking,
      });
    }
  }, [patient]);
  ...
  const handleCancelEdit = () => {
    setFormData({
      ...
      employeeEmail: patient.employeeEmail,
      address: patient.address,
      employeeSpecialization: patient.employeeSpecialization || [], // Chuyển đổi thành chuỗi nếu là mảng
      workingTime: workingTimeObject,
      urlAvatar: patient.urlAvatar,
      isWorking: patient.isWorking,
    });
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Dialog open={open} onClose={handleClose} maxWidth="lg" fullWidth>
        ...
        <DialogContent>
          ...
          >
            <Typography variant="h6">Trạng thái hoạt động:</Typography>
            <FormControlLabel
              control={
                <Checkbox
