...
const CreatePatient = ({ open, onClose }) => {
  ...
  const { CreatePatient, loading, error, success } = useCreatePatient();
  ...
  const handleCreate = () => {
    ...
    CreatePatient(patientData, imageFile); // Gọi hàm tạo bác sĩ từ hook
  };
